...
@section('content')
    ...
    <div class="topSentou">
        ...
        <div class="topSentou_wrap">
                                    ...
                                    <ul class="Top_sento_datail">
                                        ...
                                        <li>
                                            <span class="p-saunaItemSpec_icon"><img
                                                    src="/assets/img/global/circle_sauna.svg" alt="温"></span>
                                        ...
                                        <li>
                                            <span class="p-saunaItemSpec_icon"><img
                                                    src="/assets/img/global/circle_loyly.svg" alt="サ"></span>
                                            <span class="p-saunaItemSpec_value"><img
                                                    src="/assets/img/global/icon_notavailable.svg" alt=""></span>
                                            <span>
            ...
            @endforelse
            <div class="pagenation">{{ $sentos->onEachSide(3)->links() }}</div>
